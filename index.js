...
(function type(id = 0) { // Function to send typing request to channel
    ...
    typing.on("close", () => config.channel[id + 1] ? type(id + 1) : setTimeout(() => type(), config.timeout || 9000)); // On close, run tyoe function again for any more channels or wait x to repeat
